...
class HANKModelClass(EconModelClass,GEModelClass):
    ...
    def settings(self):
        ...
        self.unknowns = ['L', 'pi_w', 'B'] # endogenous inputs
    ...
    def setup(self):
        ...
        # g. shocks
        par.jump_G = 0.01/5 # initial jump
        par.rho_G = 0.8 # AR(1) coefficeint
        par.std_G = 0.00 # std.
        ...
        par.max_iter_broyden = 200 # maximum number of iteration when solving eq. system
